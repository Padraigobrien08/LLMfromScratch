...
| Pillar | Status |
| --- | --- |
| Package, config system, data pipeline, trainer, CI | **Done** — 387 tests green, end-to-end verified |
...
tests/        387 tests — component correctness, config validation, end-to-end training
