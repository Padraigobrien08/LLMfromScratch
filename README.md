...
| Pillar | Status |
| --- | --- |
| Package, config system, data pipeline, trainer, CI | **Done** — 402 tests green, end-to-end verified |
...
tests/        402 tests — component correctness, config validation, end-to-end training
