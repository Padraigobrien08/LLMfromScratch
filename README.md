...
| Pillar | Status |
| --- | --- |
| Package, config system, data pipeline, trainer, CI | **Done** — 394 tests green, end-to-end verified |
...
tests/        394 tests — component correctness, config validation, end-to-end training
